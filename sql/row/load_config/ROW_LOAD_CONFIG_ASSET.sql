BEGIN
    ...
    *************************************************************************************/
    ...
    VALUES ('ASSET', 'VALIDATE', 'STG_INPUT_03', 'ERR_VALIDATION', 
            '{"validations":
                [
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('ASSET', 'MAP_FIELDS', 'STG_INPUT_03', 'STG_MAP_03', 
            '{"mappings":
                [
    ...
    -- INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    -- VALUES ('ASSET', 'TRANSFORM_AGGREGATE', 'STG_TRANSFORM_02', 'STG_TRANSFORM_01', 
    --         '{"transformations":
    --             [
    --                 {"fieldName":"FIELD_011"
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('ASSET', 'LDR', 'STG_TRANSFORM_03', 'LDR_03', 
            '{
