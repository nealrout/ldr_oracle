BEGIN
    ...
    *************************************************************************************/
    ...
    VALUES ('FACILITY', 'MAP_FIELDS', 2, 'STG_INPUT_02', 'STG_MAP_02', 
            '{"mappings":
                [
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('FACILITY', 'TRANSFORM_INLINE', 2, 'STG_MAP_02', 'STG_TRANSFORM_02', 
            '{"transformations":
                [
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('FACILITY', 'LDR', 2, 'STG_TRANSFORM_02', 'LDR_02', 
            '{
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('FACILITY', 'OUT', 2, 'LDR_02', 'FACILITY', 
            '{"mappings":
                [
