BEGIN
    ...
    *************************************************************************************/
    ...
    VALUES ('SERVICE', 'VALIDATE', 4, 'STG_INPUT_04', 'ERR_VALIDATION', 
            '{"validations":
                [
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('SERVICE', 'MAP_FIELDS', 4, 'STG_INPUT_04', 'STG_MAP_04', 
            '{"mappings":
                [
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('SERVICE', 'TRANSFORM_INLINE', 4, 'STG_MAP_04', 'STG_TRANSFORM_04', 
            '{"transformations":
                [
    ...
    -- INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    -- VALUES ('SERVICE', 'TRANSFORM_AGGREGATE', 4, 'STG_TRANSFORM_02', 'STG_TRANSFORM_01', 
    --         '{"transformations":
    --             [
    --                 {"fieldName":"FIELD_011"
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('SERVICE', 'LDR', 4, 'STG_TRANSFORM_04', 'LDR_04', 
            '{
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('SERVICE', 'OUT', 4, 'LDR_04', 'SERVICE', 
            '{"mappings":
                [
