BEGIN
    ...
    *************************************************************************************/
    ...
    VALUES ('ACCOUNT', 'VALIDATE', 1, 'STG_INPUT_01', 'ERR_VALIDATION', 
            '{"validations":
                [
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('ACCOUNT', 'MAP_FIELDS', 1, 'STG_INPUT_01', 'STG_MAP_01', 
            '{"mappings":
                [
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('ACCOUNT', 'TRANSFORM_INLINE', 1, 'STG_MAP_01', 'STG_TRANSFORM_01', 
            '{"transformations":
                [
    ...
    /* TRANSFORM_AGGREGATE ARE AGGREAGET SUCH AS SUM, COUNT, MAX, ETC.  ANY GROUP BY SHOULD WORK
        THE INNER_MERGE_KEY THAT IS GROUPED BY WILL BE USED TO MATCH THE UNIQUEIDENTIFIER WHEN UPDATING .
        BELOW WE ARE GETTING THE COUNT OF FACILITIES PER ACCOUNT.  ACCOUNT IS THE 01 DOMAIN, AND FACILITY IS 02*/
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('ACCOUNT', 'TRANSFORM_AGGREGATE', 1, 'STG_TRANSFORM_02', 'STG_TRANSFORM_01', 
            '{"transformations":
                [
                    {"fieldName":"FIELD_011"
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('ACCOUNT', 'LDR', 1, 'STG_TRANSFORM_01', 'LDR_01', 
            '{
    ...
    INSERT INTO LOAD_CONFIG(ALIAS, STEP_CODE, STEP_ORDER, SRC_TABLE, TGT_TABLE, CONFIG, CREATE_TS)
    VALUES ('ACCOUNT', 'OUT', 1, 'LDR_01', 'ACCOUNT', 
            '{"mappings":
                [
