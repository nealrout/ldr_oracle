BEGIN
    INSERT ALL
        ...
        INTO LOAD_STEP (STEP_CODE, STEP_NUMBER, DESCRIPTION, CREATE_TS) VALUES ('LDR', 5, 'MERGE DATA FROM STG TO LDR', SYSTIMESTAMP)
        INTO LOAD_STEP (STEP_CODE, STEP_NUMBER, DESCRIPTION, CREATE_TS) VALUES ('OUT', 6, 'WRITE DATA OUT TO MAIN TABLES', SYSTIMESTAMP)
    SELECT * FROM DUAL;
